...
<body>
    ...
    <form action="refactored.php" method="POST">
        ...
        <select id="from" name="from"> <!--  loop through all currencies to make the droplist of currencies and select the previous selected currency if a change rate has been made->
        ...
        <select id="to" name="to"> <!--  loop through all currencies to make the droplist of currencies and select the previous selected currency if a change rate has been made->
            <?php foreach ($currencies as $code => $name) : ?>
